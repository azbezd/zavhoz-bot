...
Для add_item оставляй item_id ПУСТЫМ ("") — id присвоит система. item_id заполняй
только для операций над существующей позицией (update_item/adjust_qty/mark_used).
